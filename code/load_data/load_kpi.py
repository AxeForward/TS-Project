...
def load_raw_KPI(train_filename, test_filename):
...
if __name__ == '__main__':
    ...
    data1, labels1, timestamps1, data2, labels2, timestamps2 = load_raw_KPI('data/KPI/phase2_train.csv', 'data/KPI/phase2_ground_truth.hdf')
    ...
    with open('data/KPI/kpi.pkl', 'wb') as f:
        pickle.dump({
